...
/**
 * Модель окончаний (номер и список окончаний с привязанными к ним граммемами).
 * 
 * @author fedor
 *
 */
class EndingModel implements Serializable {
	/**
	 * Окончание с текстовым значением и граммемами.
	 * 
	 * @author fedor
	 *
	 */
	public class Ending implements Serializable {
		...
		public int hashCode() {
			...
			result = prime * result + ((grammemes == null) ? 0 : grammemes.hashCode());
	 ...
	 * 
	 * Основное правило: Если хеш-коды разные, то и входные объекты гарантированно разные. Если
	 * хеш-коды равны, то входные объекты не всегда равны.
	 */@Override
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
	...
	@Override
	public String toString() {
		return "[hashCode=" + hashCode + ", modelNum=" + modelNum + ", endings=" + endings + "]";
	}
